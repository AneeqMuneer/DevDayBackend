...
exports.SendProjectRegistrationReceiptMail = async (team_name, email) => {
    try {
        const transporter = nodemailer.createTransport({
            service: 'gmail',
            host: 'smtp.gmail.com',
        ...
        const mailOptions = {
            from: process.env.EMAIL,
            to: email,
            subject: 'Registration Request Received for Project Xtreme - Developers Day 2025',
            html: `
<!DOCTYPE html>
<html lang="en">
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Registration Received - Developers Day 2025</title>
</head>
    ...
    <div style="margin: 0px 5px; padding: 0px;">
      <div style="margin: 5px 0px 0px 0px; background: linear-gradient(to bottom right, #a02723, #000000); color: #FFFFFF; padding: 10px; border-radius: 10px; box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.3);">
        ...
        <p style="margin-bottom: 0px; text-align: justify; padding: 0 25px 15px; font-size: 15px;">
          Dear <strong>${team_name}</strong>,
          <br><br>
          Thank you for registering your FYP Extreme project for Developers Day 2025. We have received your registration.
          <br><br>
          <strong>Important:</strong> Your registration is currently pending payment verification. Once your payment is verified, you will receive a confirmation email.
          <br><br>
          If you have already made the payment, please allow us some time to process it. If you haven't made the payment yet, please complete it at your earliest convenience to secure your spot.
          <br><br>
        ...
        const info = await transporter.sendMail(mailOptions);
        console.log('Email sent: ' + info.response);
        console.log(`Registration receipt mail sent to ${team_name} successfully.`);
